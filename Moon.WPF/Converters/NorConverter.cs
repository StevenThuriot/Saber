...
namespace Moon.WPF.Converters
{
	/// <summary> 
	/// Converter used to perform an NOT OR operation on several booleans.
	/// </summary>
	[ValueConversion(typeof(bool), typeof(bool))]
	public class NorConverter : IMultiValueConverter
	{
		private readonly OrConverter _OrConverter;
		...
		{
			var convertedValue = _OrConverter.Convert(values, targetType, parameter, culture);
