...
namespace Moon.Domain
{
	...
	public class Period : IPeriod
	{
		...
		/// <summary>
		/// Determines whether the specified <see cref="T:Moon.Domain.Period"/> is equal to the current <see cref="T:Moon.Domain.Period"/>.
		/// </summary>
		/// <returns>
		/// true if the specified <see cref="T:Moon.Domain.Period"/> is equal to the current <see cref="T:Moon.Domain.Period"/>; otherwise, false.
		/// </returns>
		/// <param name="other">The <see cref="T:Moon.Domain.Period"/> to compare with the current <see cref="T:Moon.Domain.Period"/>. 
